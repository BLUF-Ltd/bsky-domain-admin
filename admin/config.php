...
// This is a config file for our BlueSky resolver, to make it a little simpler for
// other people to use, if they want to

// this is the custom domain you want to use on BlueSky for your users
